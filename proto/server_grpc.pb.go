...
func (c *serverClient) GetInfo(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ServerInfo, error) {
	out := new(ServerInfo)
	err := c.cc.Invoke(ctx, "/server.Server/GetInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Server_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.Server/GetInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).GetInfo(ctx, req.(*EmptyRequest))
	}
